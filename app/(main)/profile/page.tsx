      ...
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center max-w-sm">
          ...
          <button
            ...
            className="px-8 py-3 bg-primary text-white rounded-xl text-sm font-semibold hover:brightness-110 transition-all"
          >
            Sign in
          </button>
        </div>
    ...
    <div className="py-6 space-y-8 max-w-2xl mx-auto">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-xl font-heading text-text truncate">
