...
export async function GET() {
  try {
    ...
    // Fetch all units + lessons ordered
    ...
    // Build response: units with nested lessons + progress
    const pathData = units.map((unit, idx) => {
    ...
    console.error('[API] /learn/path error:', error);
