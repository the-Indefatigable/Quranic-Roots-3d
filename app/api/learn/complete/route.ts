...
export async function POST(request: NextRequest) {
  try {
    ...
    // Find the next lesson in this unit
    ...
    // Award gems for daily goal completion
    let gemsEarned = 0;
    ...
    // ── 7. Update league XP ──────────────────────────────
    // Find current league membership and add XP
    await dbQuery(() =>
    ...
    console.error('[API] /learn/complete error:', error);
