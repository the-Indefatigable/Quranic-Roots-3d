        ...
        >
          ...
          >
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <tbody>
                {activeTenseModal.tense.conjugation.map((c) => (
                  <tr key={c.person} style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                    <td style={{ padding: '12px 0', color: '#666688', fontFamily: 'monospace', fontSize: '12px', width: '40px' }}>
                      {c.person}
                    </td>
                    <td
                      style={{
                        padding: '12px 16px',
                        fontFamily: c.arabic === '-' ? 'monospace' : "'Scheherazade New', serif",
                        fontSize: c.arabic === '-' ? '16px' : '26px',
                        direction: 'rtl',
                        color: c.arabic === '-' ? 'rgba(255,255,255,0.2)' : '#ffffff',
                        textAlign: 'right',
                        textShadow: c.arabic === '-' ? 'none' : `0 0 10px ${TENSE_COLORS[activeTenseModal.tense.type] ?? '#ccc'}44`,
                      }}
                    >
                      {c.arabic === '-' ? '—' : c.arabic}
                    </td>
                    <td style={{ padding: '12px 0', textAlign: 'left' }}>
                      <div style={{ color: '#aaaabb', fontSize: '13px', fontStyle: 'italic', marginBottom: '2px' }}>
                        {c.transliteration}
                      </div>
