    ...
    <div className="min-h-screen overflow-x-hidden relative" style={{ color: '#EDEDEC' }}>
      ...
      >
        ...
        <div className="flex items-center gap-2.5">
          {/* Mobile-visible Support entry (the nav links are hidden on mobile) */}
          <Link
            href="/support"
            aria-label="Support QuRoots"
            className="sm:hidden flex items-center justify-center w-9 h-9 rounded-xl"
            style={{ background: 'rgba(212,162,70,0.12)', color: '#D4A246', border: '1px solid rgba(212,162,70,0.25)' }}
          >
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl mx-auto page-enter">
          ...
          {/* Support pill — visible on mobile and desktop */}
          <div className="flex justify-center mb-4">
            <Link
              href="/support"
              className="inline-flex items-center gap-1.5 text-xs font-semibold px-4 py-2 rounded-full transition-all duration-200 hover:-translate-y-0.5"
              style={{ background: 'rgba(212,162,70,0.1)', border: '1px solid rgba(212,162,70,0.3)', color: '#D4A246' }}
            >
              <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
              </svg>
              QuRoots is free — support it
            </Link>
          </div>
        </div>
