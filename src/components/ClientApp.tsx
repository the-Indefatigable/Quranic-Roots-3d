...
const TreeView      = React.lazy(() => import('./TreeView').then(m => ({ default: m.TreeView })));
const SimulationHUD = React.lazy(() => import('./SimulationHUD').then(m => ({ default: m.SimulationHUD })));
const QuizMode      = React.lazy(() => import('./QuizMode').then(m => ({ default: m.QuizMode })));
const StatsPanel    = React.lazy(() => import('./StatsPanel').then(m => ({ default: m.StatsPanel })));
const ExplorePanel  = React.lazy(() => import('./ExplorePanel').then(m => ({ default: m.ExplorePanel })));
