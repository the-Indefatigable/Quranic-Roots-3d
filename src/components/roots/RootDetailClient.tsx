            ...
            >
              <div className="flex items-center gap-4">
                <div className="flex items-center justify-center w-9 h-9 rounded-xl bg-primary-light">
                  <span className="text-xs text-primary font-semibold">{form.formNumber}</span>
                </div>
                <div>
                ...
                >
                  <div className="px-5 pb-5 border-t border-border-light">
                    ...
                    <div className="flex flex-wrap gap-x-8 gap-y-3 py-4 text-sm">
                      ...
                      {form.masdar && (
                        <div>
                          <span className="text-[10px] text-text-tertiary uppercase tracking-wider block mb-0.5">Masdar</span>
                          <ArabicText size="base" className="text-primary">{form.masdar}</ArabicText>
                        </div>
                      )}
                      {form.faaeil && (
                        <div>
