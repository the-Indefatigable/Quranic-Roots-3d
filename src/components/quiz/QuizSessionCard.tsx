...
export function QuizSessionCard({ correctCount, totalCount, elapsedSeconds }: QuizSessionCardProps) {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bg-gradient-to-b from-background to-background/80 backdrop-blur-sm border-b border-white/[0.08] z-40">
      <div className="max-w-2xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-lg font-bold text-gold">{correctCount}</p>
          </div>
        </div>
